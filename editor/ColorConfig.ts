    ...
    public static readonly themes: { [name: string]: string } = {
      "swag01": `
			:root {
				...
				--white-piano-key: #abd;
				--black-piano-key: #236;
				--white-piano-key-text: #124;
				--black-piano-key-text: #bce;
					...
					--indicator-primary: #a4f;
					--indicator-secondary: #126;
					--select2-opt-group: #585858;
					--input-box-outline: #123;
					--mute-button-normal: #c23;
					--mute-button-mod: #a4f;
				--pitch1-secondary-channel: #2FB59C;
				--pitch1-primary-channel:   #33EEC7;
				--pitch1-secondary-note:    #2FB59C;
				--pitch1-primary-note:      #2DFFCE;
				--pitch2-secondary-channel: #549BB7;
				--pitch2-primary-channel:   #5FC6EF;
				--pitch2-secondary-note:    #549BB7;
				--pitch2-primary-note:      #56CDFC;
				--pitch3-secondary-channel: #3E5EB7;
				--pitch3-primary-channel:   #4473EF;
				--pitch3-secondary-note:    #3E5EB7;
				--pitch3-primary-note:      #3C75FC;
				--pitch4-secondary-channel: #532FB7;
				--pitch4-primary-channel:   #6133EF;
				--pitch4-secondary-note:    #532FB7;
				--pitch4-primary-note:      #6C40F9;
				--pitch5-secondary-channel: #9133C4;
				--pitch5-primary-channel:   #AF34F3;
				--pitch5-secondary-note:    #9133C4;
				--pitch5-primary-note:      #B232FC;
				--pitch6-secondary-channel: #B5136C;
				--pitch6-primary-channel:   #EE148E;
				--pitch6-secondary-note:    #B5136C;
				--pitch6-primary-note:      #FC1295;
				--pitch7-secondary-channel: #AD1A1A;
				--pitch7-primary-channel:   #EB1E1D;
				--pitch7-secondary-note:    #AD1A1A;
				--pitch7-primary-note:      #FC1B1A;
				--pitch8-secondary-channel: #AD501A;
				--pitch8-primary-channel:   #EB661D;
				--pitch8-secondary-note:    #AD501A;
				--pitch8-primary-note:      #FC691A;
				--pitch9-secondary-channel: #CE911E;
				--pitch9-primary-channel:   #F6A71E;
				--pitch9-secondary-note:    #CE911E;
				--pitch9-primary-note:      #FCAA2F;
				--pitch10-secondary-channel:#8CA527;
				--pitch10-primary-channel:  #C2E72D;
				--pitch10-secondary-note:   #8CA527;
				--pitch10-primary-note:     #D1FB28;
				--noise1-secondary-channel: #636363;
				--noise1-primary-channel:   #AEAEAE;
				--noise1-secondary-note:    #636363;
				--noise1-primary-note:      #EBEBEB;
				--noise2-secondary-channel: #6B641F;
				--noise2-primary-channel:   #B8A92D;
				--noise2-secondary-note:    #6B641F;
				--noise2-primary-note:      #EFD631;
				--noise3-secondary-channel: #256B1F;
				--noise3-primary-channel:   #3BB82D;
				--noise3-secondary-note:    #256B1F;
				--noise3-primary-note:      #44EF31;
				--noise4-secondary-channel: #1F6B5D;
				--noise4-primary-channel:   #2DB89E;
				--noise4-secondary-note:    #1F6B5D;
				--noise4-primary-note:      #31EFC7;
				--noise5-secondary-channel: #252D82;
				--noise5-primary-channel:   #313FCF;
				--noise5-secondary-note:    #252D82;
				--noise5-primary-note:      #3045F6;
                    --mod1-secondary-channel:   #BFCE3D;
					--mod1-primary-channel:     #CBED7A;
					--mod1-secondary-note:      #BFCE3D;
					--mod1-primary-note:        #E6FFA8;
					--mod2-secondary-channel:   #67CE3D;
					--mod2-primary-channel:     #7BED7A;
					--mod2-secondary-note:      #67CE3D;
					--mod2-primary-note:        #A8FFA8;
					--mod3-secondary-channel:   #3DCE6C;
					--mod3-primary-channel:     #7AEDCA;
					--mod3-secondary-note:      #3DCE6C;
					--mod3-primary-note:        #A8FFE6;
					--mod4-secondary-channel:   #3DCEB6;
					--mod4-primary-channel:     #7ACCED;
					--mod4-secondary-note:      #3DCEB6;
					--mod4-primary-note:        #A8E6FF;
					--mod-label-primary:        #53b;
					--mod-label-secondary-text: #000;
					--mod-label-primary-text:   #a9e;
